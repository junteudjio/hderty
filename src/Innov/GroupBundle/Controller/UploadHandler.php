...
class UploadHandler
{
    ...
    public $fbody; // ajouter par kdiri et moi
    public $ffread; //ajouter par kadiri et moi
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/cliches/',
            'upload_url' => $this->get_full_url().'/uploads/cliches/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function readfile($file_path) {
        ...
        if ($chunk_size && $file_size > $chunk_size) {
            ...
            while (!feof($handle)) {
                $this->ffread = fread($handle, $chunk_size);
                ob_flush();
                flush();
            }
            fclose($handle);
