...
/* InnovGroupBundle:Group:accueil2.html.twig */
class __TwigTemplate_d4912e5fed970e16cb28fc18203cdf3eac44f3357f0aff74f2bd7e6f4032dbf6 extends Twig_Template
{
...
<html lang=\"en\">
    <head>
        ...
        <meta name=\"description\" content=\"Les étudiants l'adorent avant, pendant et après leurs examens\">
        ...
        <style type=\"text/css\">@charset \"utf-8\";
                ...
                body.pinned-drawer.extra-large-window:not(.promo-page) #surface,body.pinned-drawer.large-window:not(.promo-page) #surface{margin-left:280px}
                body.pinned-drawer.extra-large-window:not(.promo-page) .header-boards,body.pinned-drawer.large-window:not(.promo-page) .header-boards{display:none}
                body.overflow-hidden{overflow:hidden}
                body.single-column #content{margin:0 auto 32px;padding:32px;max-width:650px}body.single-column #content .window-header{margin-bottom:0}
                ...
                body.small-window.single-column #content{padding:16px 8px}
                #nocss{display:none}
                ...
                .sticker-edit-button{display:none}
                ...
                input[type=\"radio\"]{-webkit-appearance:radio;min-height:inherit}
                ...
                input::-moz-placeholder{color:#939393}
                textarea::-moz-placeholder{color:#939393}
                .button-link{background:#fff;background:-webkit-linear-gradient(top, #fff 0, #f0f0f0 100%);background:linear-gradient(to bottom, #fff 0, #f0f0f0 100%);border-radius:3px;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border:1px solid #d6d6d6;border-bottom-color:#bdbdbd;cursor:pointer;display:block;font-weight:bold;height:18px;margin-top:6px;max-width:250px;overflow:hidden;white-space:nowrap;padding:6px;position:relative;text-decoration:none;text-overflow:ellipsis;}.button-link .on{background:#24a828;background:-webkit-linear-gradient(top, #24a828 0, #1b7e1e 100%);background:linear-gradient(to bottom, #24a828 0, #1b7e1e 100%);border-radius:3px;color:#fff;display:none;font-size:12px;font-weight:bold;height:17px;line-height:17px;margin:0;padding:2px 4px;position:absolute;right:5px;top:5px;text-align:center}
                ...
                .button-link.disabled,.button-link.disabled:hover,.button-link.disabled:active,.button-link.disabled.primary,.button-link.disabled.primary:hover,.button-link.disabled.primary:active{background:#cfcfcf;border-color:#c2c2c2;border-bottom-color:#b5b5b5;cursor:default;-webkit-box-shadow:none;box-shadow:none;color:#a8a8a8}.button-link.disabled .icon-sm,.button-link.disabled:hover .icon-sm,.button-link.disabled:active .icon-sm,.button-link.disabled.primary .icon-sm,.button-link.disabled.primary:hover .icon-sm,.button-link.disabled.primary:active .icon-sm{color:#a9a9a9}
                ...
                @font-face{font-family:'Trellicons Regular';src:url('data:application/font-woff;base64,') format(\"woff\"),url(\"https://d2k1ftgv7pobq7.cloudfront.net/fonts/aa0d021179874eeaf0873f8f28a60690/trellicons-regular.ttf\") format(\"truetype\"),url(\"https://d2k1ftgv7pobq7.cloudfront.net/fonts/7b634846a91e67b6f44f351e7e5cc074/trellicons-regular.svg#trelliconsregular\") format(\"svg\");font-weight:normal;font-style:normal}.icon-lg,.icon-sm{color:#a9a9a9;display:inline-block;font-family:\"Trellicons Regular\";-webkit-font-smoothing:antialiased;font-style:normal;font-weight:normal;line-height:1;text-align:center;text-decoration:none}.icon-lg.custom-image,.icon-sm.custom-image{text-indent:100%;overflow:hidden}.icon-lg.custom-image img,.icon-sm.custom-image img{overflow:hidden;position:absolute;top:0;left:0}
                @font-face{font-family:'Trellicons Regular SVG';src:url(\"https://d2k1ftgv7pobq7.cloudfront.net/fonts/7b634846a91e67b6f44f351e7e5cc074/trellicons-regular.svg#trelliconsregular\") format(\"svg\");font-weight:normal;font-style:normal}.windows.chrome .icon-lg,.windows.chrome .icon-sm{font-family:\"Trellicons Regular SVG\"}
                ...
                .icon-briefcase-bc-color{color:#71838e}
                ...
                .icon-cover:before{content:\"\\f044\"}
                ...
                .icon-open:before{content:\"\\f045\"}
                .icon-movedown:before,.icon-move:before{content:\"\\f030\"}
                .icon-movedown{-webkit-transform:rotate(90deg);transform:rotate(90deg)}
                .icon-edit:before{content:\"\\f031\"}
                .icon-star:before{content:\"\\f042\"}
                .icon-star-active{color:#e6bf00}
                .icon-filter:before{content:\"\\f043\"}
                ...
                h3,h4,h5,h6{font-size:16px;line-height:1.25em;margin:0 0 6px}
                ...
                a.disabled,a.disabled:hover{color:#939393;cursor:default;text-decoration:none}
                ...
                .markeddown code{word-wrap:normal;border-radius:3px;background-color:#ddd;padding-left:2px;padding-right:2px}
                .markeddown pre code{padding:0}
                .markeddown ul,.markeddown ol{margin:4px 0 12px 0}.markeddown ul ul,.markeddown ol ul,.markeddown ul ol,.markeddown ol ol{margin-left:24px}
                .markeddown ul>li{list-style:disc;margin:0 0 8px 24px}
                .markeddown ol>li{list-style:decimal;margin:0 0 8px 24px}
                ...
                .header-btn.header-go-to-boards{padding:0 8px 0 38px}.header-btn.header-go-to-boards .member{border-top-left-radius:3px;border-top-right-radius:0;border-bottom-right-radius:0;border-bottom-left-radius:3px;position:absolute;left:0}
                .header-user{position:absolute;top:5px;right:0}
                ...
                .header-banner{font-size:16px;font-weight:bold;line-height:20px;text-align:center;-webkit-transition:background ease-in 250ms,padding ease-in 250ms;transition:background ease-in 250ms,padding ease-in 250ms;padding:10px;position:relative;word-wrap:break-word}.header-banner .quiet{display:inline-block}
                ...
                .pop-over textarea{height:72px;margin:4px 0 12px;width:100%}
                ...
                .pop-over .header{height:26px;position:relative;border-bottom:1px solid #dcdcdc;margin-bottom:4px;text-align:center}.pop-over .header .header-title{color:#939393;display:block;font-weight:bold;line-height:21px;overflow:hidden;padding:0 24px;text-overflow:ellipsis;white-space:nowrap;width:220px}
                ...
                .pop-over-list.checkable.left-check li a{padding-right:10px;padding-left:30px}
                ...
                .pop-over-list.navigable li>a:hover .icon-sm{color:#a9a9a9}
                ...
                .pop-over-label-list li,.pop-over-member-list li,.pop-over-emoji-list li,.draggable-member li{list-style:none}.pop-over-label-list li a,.pop-over-member-list li a,.pop-over-emoji-list li a,.draggable-member li a{border-radius:3px;display:block;height:30px;line-height:30px;overflow:hidden;position:relative;text-overflow:ellipsis;text-decoration:none;white-space:nowrap;padding:4px;margin-bottom:2px}.pop-over-label-list li a.multi-line,.pop-over-member-list li a.multi-line,.pop-over-emoji-list li a.multi-line,.draggable-member li a.multi-line{line-height:16px}
                .pop-over-label-list li a .member,.pop-over-member-list li a .member,.pop-over-emoji-list li a .member,.draggable-member li a .member{margin-right:8px}
                .pop-over-label-list li a .card-label,.pop-over-member-list li a .card-label,.pop-over-emoji-list li a .card-label,.draggable-member li a .card-label{float:left;height:30px;margin:0 8px 0 0;padding:0;width:30px}
                .pop-over-label-list li a .option,.pop-over-member-list li a .option,.pop-over-emoji-list li a .option,.draggable-member li a .option,.pop-over-label-list li a .icon-check,.pop-over-member-list li a .icon-check,.pop-over-emoji-list li a .icon-check,.draggable-member li a .icon-check{background-clip:content-box;background-origin:content-box;display:none;padding:11px;position:absolute;top:0;right:0}
                .pop-over-label-list li a .sub-name,.pop-over-member-list li a .sub-name,.pop-over-emoji-list li a .sub-name,.draggable-member li a .sub-name{font-size:12px}
                .pop-over-label-list li:last-child a,.pop-over-member-list li:last-child a,.pop-over-emoji-list li:last-child a,.draggable-member li:last-child a{margin-bottom:0}
                .pop-over-label-list li.disabled,.pop-over-member-list li.disabled,.pop-over-emoji-list li.disabled,.draggable-member li.disabled{opacity:.5}.pop-over-label-list li.disabled.active a,.pop-over-member-list li.disabled.active a,.pop-over-emoji-list li.disabled.active a,.draggable-member li.disabled.active a,.pop-over-label-list li.disabled.selected a,.pop-over-member-list li.disabled.selected a,.pop-over-emoji-list li.disabled.selected a,.draggable-member li.disabled.selected a{background:none;color:#393939;cursor:default}.pop-over-label-list li.disabled.active a .quiet,.pop-over-member-list li.disabled.active a .quiet,.pop-over-emoji-list li.disabled.active a .quiet,.draggable-member li.disabled.active a .quiet,.pop-over-label-list li.disabled.selected a .quiet,.pop-over-member-list li.disabled.selected a .quiet,.pop-over-emoji-list li.disabled.selected a .quiet,.draggable-member li.disabled.selected a .quiet{color:#939393}
                .pop-over-label-list li.email-invite .member,.pop-over-member-list li.email-invite .member,.pop-over-emoji-list li.email-invite .member,.draggable-member li.email-invite .member{display:none}
                .pop-over-label-list li.email-invite a,.pop-over-member-list li.email-invite a,.pop-over-emoji-list li.email-invite a,.draggable-member li.email-invite a{padding:0 10px}
                .pop-over-label-list li.selected a,.pop-over-member-list li.selected a,.pop-over-emoji-list li.selected a,.draggable-member li.selected a{background-color:#318ec4;color:#fff}.pop-over-label-list li.selected a .quiet,.pop-over-member-list li.selected a .quiet,.pop-over-emoji-list li.selected a .quiet,.draggable-member li.selected a .quiet{color:#eee}
                .pop-over-label-list li.selected a .card-label,.pop-over-member-list li.selected a .card-label,.pop-over-emoji-list li.selected a .card-label,.draggable-member li.selected a .card-label{border-radius:3px}
                .pop-over-label-list li.selected a .icon-check,.pop-over-member-list li.selected a .icon-check,.pop-over-emoji-list li.selected a .icon-check,.draggable-member li.selected a .icon-check{color:#fff}
                .pop-over-label-list li.active a .icon-check,.pop-over-member-list li.active a .icon-check,.pop-over-emoji-list li.active a .icon-check,.draggable-member li.active a .icon-check{display:block}
                .pop-over-label-list li.unconfirmed a.name,.pop-over-member-list li.unconfirmed a.name,.pop-over-emoji-list li.unconfirmed a.name,.draggable-member li.unconfirmed a.name{line-height:16px}
                .pop-over-label-list.options li.selected a,.pop-over-member-list.options li.selected a,.pop-over-emoji-list.options li.selected a,.draggable-member.options li.selected a{padding-right:28px}.pop-over-label-list.options li.selected a .option,.pop-over-member-list.options li.selected a .option,.pop-over-emoji-list.options li.selected a .option,.draggable-member.options li.selected a .option{display:block;opacity:.5}
                .pop-over-label-list.options li.selected a .option:hover,.pop-over-member-list.options li.selected a .option:hover,.pop-over-emoji-list.options li.selected a .option:hover,.draggable-member.options li.selected a .option:hover{opacity:1}
                .pop-over-label-list.options li.disabled.selected a,.pop-over-member-list.options li.disabled.selected a,.pop-over-emoji-list.options li.disabled.selected a,.draggable-member.options li.disabled.selected a{padding-right:0}.pop-over-label-list.options li.disabled.selected a .option,.pop-over-member-list.options li.disabled.selected a .option,.pop-over-emoji-list.options li.disabled.selected a .option,.draggable-member.options li.disabled.selected a .option{display:none}
                .pop-over-label-list.options li.no-option.selected a,.pop-over-member-list.options li.no-option.selected a,.pop-over-emoji-list.options li.no-option.selected a,.draggable-member.options li.no-option.selected a{padding-right:6px}.pop-over-label-list.options li.no-option.selected a .option,.pop-over-member-list.options li.no-option.selected a .option,.pop-over-emoji-list.options li.no-option.selected a .option,.draggable-member.options li.no-option.selected a .option{display:none}
                .pop-over-label-list.collapsed.checkable li.active a,.pop-over-member-list.collapsed.checkable li.active a,.pop-over-emoji-list.collapsed.checkable li.active a,.draggable-member.collapsed.checkable li.active a{padding-right:0}
                .pop-over-label-list.collapsed li,.pop-over-member-list.collapsed li,.pop-over-emoji-list.collapsed li,.draggable-member.collapsed li{float:left;margin:0 3px 3px 0}.pop-over-label-list.collapsed li a,.pop-over-member-list.collapsed li a,.pop-over-emoji-list.collapsed li a,.draggable-member.collapsed li a{padding:0;margin:0;width:30px}.pop-over-label-list.collapsed li a .member,.pop-over-member-list.collapsed li a .member,.pop-over-emoji-list.collapsed li a .member,.draggable-member.collapsed li a .member{opacity:.8}
                .pop-over-label-list.collapsed li a .full-name,.pop-over-member-list.collapsed li a .full-name,.pop-over-emoji-list.collapsed li a .full-name,.draggable-member.collapsed li a .full-name{display:none}
                .pop-over-label-list.collapsed li.selected a .member,.pop-over-member-list.collapsed li.selected a .member,.pop-over-emoji-list.collapsed li.selected a .member,.draggable-member.collapsed li.selected a .member{border-color:#318ec4;opacity:.9}
                .pop-over-label-list.collapsed li.active.selected a .member,.pop-over-member-list.collapsed li.active.selected a .member,.pop-over-emoji-list.collapsed li.active.selected a .member,.draggable-member.collapsed li.active.selected a .member{border-color:#318ec4;opacity:.9}
                .pop-over-label-list.collapsed li.active a .member,.pop-over-member-list.collapsed li.active a .member,.pop-over-emoji-list.collapsed li.active a .member,.draggable-member.collapsed li.active a .member{border-color:#2e85b8;opacity:1}
                .pop-over-label-list.collapsed li.active a .icon-check,.pop-over-member-list.collapsed li.active a .icon-check,.pop-over-emoji-list.collapsed li.active a .icon-check,.draggable-member.collapsed li.active a .icon-check{border-radius:3px;background-color:#2e85b8;bottom:0;color:#fff;display:block;padding:0;right:0;top:auto}
                .pop-over-label-list.checkable li.active a,.pop-over-member-list.checkable li.active a,.pop-over-emoji-list.checkable li.active a,.draggable-member.checkable li.active a{padding-right:28px}
                .pop-over-label-list.filtered li,.pop-over-member-list.filtered li,.pop-over-emoji-list.filtered li,.draggable-member.filtered li{display:none}.pop-over-label-list.filtered li.matches-filter,.pop-over-member-list.filtered li.matches-filter,.pop-over-emoji-list.filtered li.matches-filter,.draggable-member.filtered li.matches-filter{display:block}
                .pop-over-label-list.limited li.exceeds-limit,.pop-over-member-list.limited li.exceeds-limit,.pop-over-emoji-list.limited li.exceeds-limit,.draggable-member.limited li.exceeds-limit{display:none}
                ...
                @media screen and (max-height:1000px){.fanclub-section-wrapper{padding-top:8%;padding-bottom:8%}}@media screen and (max-width:600px){.fanclub-section-wrapper p{font-size:20px;line-height:1.3em;margin-bottom:1.1em} .fanclub-section-wrapper h1{font-size:36px;margin:0 0 .9em} .fanclub-section-wrapper h2{font-size:28px;margin:0 0 .9em} .fanclub-section .trellogold-background-demo{height:270px} .fanclub-section-header .fanclub-section-header-image{height:auto}}.promo-platforms{text-align:center;margin:60px auto;max-width:1200px}
                .promo-platforms-apps,.promo-platforms-browsers{margin:0 0 48px;padding:16px 8px}
                .promo-platforms-browser-item,.promo-platforms-app-item{border-radius:8px;display:inline-block;width:210px;margin:32px 8px;vertical-align:top;text-decoration:none}.promo-platforms-browser-item:hover,.promo-platforms-app-item:hover{background:#f0f0f0}.promo-platforms-browser-item:hover .promo-platforms-browser-item-image,.promo-platforms-app-item:hover .promo-platforms-browser-item-image,.promo-platforms-browser-item:hover .promo-platforms-app-item-image,.promo-platforms-app-item:hover .promo-platforms-app-item-image{-webkit-transform:scale(1.1);transform:scale(1.1)}
                .promo-platforms-browser-item:hover .promo-platforms-download-button,.promo-platforms-app-item:hover .promo-platforms-download-button{color:#393939}
                .promo-platforms-app-item{width:300px}
                .promo-platforms-browser-item-header,.promo-platforms-app-item-header{font-weight:bold;font-size:16px}
                .promo-platforms-browser-item-image,.promo-platforms-app-item-image{background-position:center;background-size:contain;background-repeat:no-repeat;display:block;margin:0 auto 12px;-webkit-transition:-webkit-transform 120ms;transition:transform 120ms}.promo-platforms-browser-item-image:hover,.promo-platforms-app-item-image:hover{-webkit-transform:scale(1.1);transform:scale(1.1)}
                .promo-platforms-browser-item-image{height:150px;width:150px}
                .promo-platforms-browser-item-image-chrome{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/8f0f45eed81df7fc42884618eb503222/chrome.png)}
                .promo-platforms-browser-item-image-firefox{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/c4d297652f3283a766e7368f7c442d51/firefox.png)}
                .promo-platforms-browser-item-image-safari{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/a63c5c6e71de645f581922ded4bf3c18/safari.png)}
                .promo-platforms-browser-item-image-ie{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/0c8d7c86e07ae443f45168b8c16c16d5/ie.png)}
                .promo-platforms-app-item-image{display:block;height:170px;margin:0 auto 16px}
                .promo-platforms-app-item-image-web{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/a8a15bffa0e3da0d044657b5c313bb23/device-macbook.png)}
                .promo-platforms-app-item-image-ios{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/727f4e2924aac13043277ac6dda751ae/device-iphone-and-ipad.png)}
                .promo-platforms-app-item-image-android{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/7dfacd8d03aa1a55b0e05844ad1c0292/device-nexus.png)}
                .promo-platforms-app-item-image-kindle{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/86e892d0b31e4bcdb0aff87902254923/device-kindle.png)}
                .promo-platforms-app-item-image-windows8{background-image:url(https://d2k1ftgv7pobq7.cloudfront.net/images/platforms/30c7af2d1e1467a0727176fcebb28c69/device-win8-tablet.png)}
                .promo-platforms-download-button{color:#939393;display:block;margin:0 0 8px;padding:8px;text-decoration:underline}
                .promo-platforms-mobile-browsers{margin:0 auto;max-width:600px;padding:0 16px}
                .promo-wrapper blockquote{color:#81919b;padding:0;margin:0 0 20px 0;border:0;font-weight:200;font-style:italic;font-size:20px;line-height:1.6em}
                ...
                @media screen and (max-width:599px){.landing-body .landing-signup-button{margin-top:20px}}#landingLogo{margin:px 0 15px 0;width:416px}
                #landingHeader{clear:both;text-align:center;padding:50px 60px}#landingHeader h1{display:none}
                #landingHeader h2{color:#81919b;font-weight:700;font-size:40px;line-height:1.2em}
 ...
 ";
        ...
        echo "
                ...
                #landingIntroVideo .intro{margin:0px 0 0 540px;font-size:20px;font-weight:200;font-family:\"facitweb\",Helvetica,sans-serif;text-align:left;line-height:1.5em}
                ...
                #landingSecondSignup .landing-signup-button{font-size:11px;border:none;border-radius:10px;padding:20px 0;width:100%;background:#164b69;margin-top:0}#landingSecondSignup .landing-signup-button:hover{background:#1a577a}
                ...
                #landingMoreInfo p a{color:#fff;text-decoration:underline}#landing-signup-buttonlandingMoreInfo p a:hover{color:rgba(255,255,255,0.8)}
                ...
                .window-module .empty-list{margin:8px 0 0 38px}
...
<link href=\"";
        ...
        <body class=\"page-landing unknown-window landing-body promo-page\">
        <div id=\"fb-root\"></div>
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
            ...
            <div id=\"nocss\">
                Your browser was unable to load all of Hdery's resources. They may have been blocked by your firewall, proxy or browser configuration.<br>Press Ctrl+F5 or Ctrl+Shift+R to have your browser try again. 
                <hr>
            </div>
            <div id=\"surface\" class=\"clearfix\">
                <div id=\"header\" style=\"padding:20px;\">
                    <div class=\"top-nav\" style=\"position:absolute;top:9px;margin-top:inherit;\">
        ...
        // line 705
        echo "                                            <li class=\"dropdown language\" style=\"margin-top:inherit;\">
        ...
        echo "\" alt=\"\"> Arabia</a></li>
                    ...
                    <div class=\"header-user\"> 
                        ...
                        <a class=\"header-btn header-signup\" href=\"";
        // line 754
        echo $this->env->getExtension('routing')->getPath("fos_user_registration_register");
        echo "\">";
        echo $this->env->getExtension('translator')->trans("innov.accueil.inscription");
        echo "</a>
                        <a class=\"header-btn header-login js-toggle-login-popover no-right-margin\" id=\"showLogin\" >";
        // line 755
        echo $this->env->getExtension('translator')->trans("innov.accueil.login");
        echo "</a>  
                    </div>
                </div>
                <p id=\"notification\"/> 
                <div id=\"content\" class=\"clearfix\">
                    <div class=\"promo-wrapper\">
                        <header id=\"landingHeader\" class=\"landing-header\">
                            <img id=\"landingLogo\" title=\"H-Derty Logo\" src=\"";
        // line 762
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("img/logo2.png"), "html", null, true);
        echo "\" width=\"33%\" height=\"33%\"> 
                            <h1>H-derty</h1>
                            <h2>";
        // line 764
        echo $this->env->getExtension('translator')->trans("innov.accueil.slogan");
        echo "</h2>
                        </header>
                        <section id=\"landingFirstSignUpButton\" class=\"landing-section\">
                            <div class=\"width-wrapper\"> <a class=\"button primary landing-signup-button js-first-sign-up-landing-boards\" href=\"";
        // line 767
        echo $this->env->getExtension('routing')->getPath("fos_user_registration_register");
        echo "\"> ";
        echo $this->env->getExtension('translator')->trans("innov.accueil.creer_compte");
        echo " </a> </div>
                        </section>
                        <section id=\"landingIntroVideo\" class=\"landing-section clearfix\">
                            <div class=\"width-wrapper\">
                                <p class=\"intro\" style='font-size:20px;font-family:\"Bradley Hand ITC\"'> <span style='font-size:35px;font-family:\"brush script mt\"'>H-Derty</span> ";
        // line 771
        echo $this->env->getExtension('translator')->trans("innov.accueil.hderty_vous_permet");
        echo " </p>
                                <p class=\"intro\" style='color:#27709B; font-family:\"brush script mt\"; font-size:25px'> \" ";
        // line 772
        echo $this->env->getExtension('translator')->trans("innov.accueil.hderty_vous_permet_conclusion");
        echo "\" </p>
                                <div class=\"video-container\">
                                    <a href=\"javascript:;\">
                                    <img src=\"https://wistia.sslcs.cdngc.net/deliveries/1bf7c205b275b5a7c6f313b2fbbdee818cc0b900.jpg?image_play_button=true&amp;image_play_button_color=006595e0&amp;image_crop_resized=480x270\" alt=\"\"></a> 
                                    
                                    <p>";
        // line 777
        echo " video coming soon !</p>
                                </div>
                                <h1>Meet H-derty</h1>
                            </div>
                        </section>
                        <section id=\"landingWhatIsTrello\" class=\"landing-section clearfix\">
                            <div class=\"width-wrapper\">
                                <h1>Trello is a productivity tool unlike any other.</h1>
                                <ul>
                                    <li id=\"whatIsTrello1\">
                                        <div class=\"content clearfix\">
                                            <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/efc043d0d7d8b238848951324e866c8b/what-is-trello1.png\" alt=\"A whiteboard with superpowers\" style=\"height: 127px; width: 250px\"/> 
                                            <h2>";
        // line 789
        echo $this->env->getExtension('translator')->trans("innov.accueil.utile");
        echo "</h2>
                                            <p>";
        // line 790
        echo $this->env->getExtension('translator')->trans("innov.accueil.utile_desc");
        echo " <span style='font-size:25px;font-family:\"brush script mt\"'> H-derty</span>
                                            </p>
                                        </div>
                                    </li>
                                    <li id=\"whatIsTrello2\">
                                        <div class=\"content clearfix\">
                                            <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/c897d8c6b5e7eefb6d058a04b4d8d739/what-is-trello3.png\" alt=\"Power tools included\" style=\"height: 127px; width: 250px\" /> 
                                            <h2>";
        // line 797
        echo $this->env->getExtension('translator')->trans("innov.accueil.social");
        echo "</h2>
                                            <p>";
        // line 798
        echo $this->env->getExtension('translator')->trans("innov.accueil.social_desc1");
        echo "<span style='font-size:25px;font-family:\"brush script mt\"'> H-derty </span>";
        echo $this->env->getExtension('translator')->trans("innov.accueil.social_desc2");
        echo "</p>
                                        </div>
                                    </li>
                                    <li id=\"whatIsTrello3\">
                                        <div class=\"content clearfix last\">
                                            <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/0c91be28312f6e79a7eecac6d182d399/what-is-trello2.png\" alt=\"Everyone on the same page\" style=\"height: 130px; width: 250px\"/> 
                                            <h2>";
        // line 804
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("innov.accueil.benefique"), "html", null, true);
        echo "</h2>
                                            <p>";
        // line 805
        echo $this->env->getExtension('translator')->trans("innov.accueil.benefique_desc1");
        echo " <span style='font-size:25px;font-family:\"brush script mt\"'> H-Derty-Mobile</span> ";
        echo $this->env->getExtension('translator')->trans("innov.accueil.benefique_desc2");
        echo "
                                            </p>
                                        </div>
                                    </li>
                                </ul>
                                <div id=\"landingSecondSignup\"> <a class=\"button landing-signup-button\" href=\"";
        // line 810
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("uploads/hderty-android.apk"), "html", null, true);
        echo "\"> ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("innov.accueil.telecharger_mobile"), "html", null, true);
        echo " </a> </div>
                            </div>
                        </section>
                        <div id=\"landingMoreInfo\" class=\"landing-section clearfix\">
                            <div class=\"width-wrapper\">
                                <div id=\"landingMoreInfoDevices\">
                                    <div class=\"device iphone\"> <a href=\"";
        // line 816
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("uploads/hderty-android.apk"), "html", null, true);
        echo "\" class=\"js-landing-app-iphone\" target=\"_blank\"><img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/13933c191551ff12d02b07404770065c/device-iphone.png\" style=\"width:110%;heigth:110%\" title=\"H-Derty pour iPhone\" /></a> </div>
                                    <div class=\"device android\"> <a href=\"";
        // line 817
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("uploads/hderty-android.apk"), "html", null, true);
        echo "\" class=\"js-landing-app-android\" target=\"_blank\"><img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/a20022e4478ad21ea8769cebc08489c8/device-android.png\" style=\"width:110%;heigth:110%;margin-left:30px\" title=\"H-Derty pour Android\" /></a> </div>
                                    <div class=\"device windows8\"> <a href=\"";
        // line 818
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("uploads/hderty-android.apk"), "html", null, true);
        echo "\" class=\"js-landing-app-win8\" target=\"_blank\"><img src=\"http://upload.wikimedia.org/wikipedia/commons/b/ba/Windows_Phone_7_mockup.png\" style=\"width:30%;heigth:30%\" title=\"H-Derty pour Windows Phone\" /></a> </div>
                                    <p><strong>";
        // line 819
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("innov.accueil.hderty_partout"), "html", null, true);
        echo "</strong>&mdash;  <a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("uploads/hderty-android.apk"), "html", null, true);
        echo "\" class=\"js-landing-app-android js-text\" target=\"_blank\">Android</a>, <a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("uploads/hderty-android.apk"), "html", null, true);
        echo "\" class=\"js-landing-app-iphone js-text\" target=\"_blank\">iPhone</a>, <a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("uploads/hderty-android.apk"), "html", null, true);
        echo "\" class=\"js-landing-app-win8 js-text\" target=\"_blank\">Windows Phone</a>, et votre <a href=\"/signup\" class=\"js-landing-app-web js-text\">navigateur web</a>. </p>
                                </div>
                            </div>
                        </div>
                        <!--   <section id=\"landingLogos\" class=\"landing-section\">
                           <div class=\"width-wrapper\">
                              <p>Trello is loved by people at <span class=\"linebreak\">organizations both big and small!</span></p>
                              <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/eac418eb73d1edbb3af82264abe0c426/chartbeat.png\" alt=\"ChartBeat\" class=\"optional\" _partoutstyle=\"height: 90px; width: 185px;\"/> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/473772a303950b197520b60e5b074004/freshdirect.png\" alt=\"Fresh Direct\" style=\"height: 90px; width: 180px;\"/> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/613a189b52b2c3cac9313a845eae9be6/lore.png\" alt=\"Lore\" style=\"height: 90px; width: 98px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/7459c132a0704d9444b87ae47d437c4e/tumblr.png\" alt=\"Tumblr\" style=\"height: 90px; width: 171px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/a726b4396ee2948addb5add3954a2cb6/scoutbooks.png\" alt=\"Scout Books\" style=\"height: 90px; width: 128px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/ff300ddb319fa568d50d73f4c2623635/anytimefitness.png\" alt=\"Anytime Fitness\" class=\"optional\" style=\"height: 90px; width: 180px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/20897210ab004e9beda004d3f95b1d9d/turntable.png\" alt=\"Turntable\" style=\"height: 90px; width: 180px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/a7c0b6b75e458082bde7fbad79f556ab/tripadvisor.png\" alt=\"Trip Advisor\" class=\"optional\" style=\"height: 81px; width: 146px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/36f37904d63cdcedc1c7fede508c463c/adobe.png\" alt=\"Adobe\" class=\"optional\" style=\"height: 81px; width: 177px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/1dfafe8c448f281cba6b522c597e8c5f/theverge.png\" alt=\"The Verge\" style=\"height: 81px; width: 179px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/dd676994b9faf5c1da391eb369bf43a7/khanacademy.png\" alt=\"Khan Academy\" style=\"height: 81px; width: 231px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/3e0e6e2a8e4cfc94b9ebe873f99f6edc/newyorktimes.png\" alt=\"New York Times\" style=\"height: 81px; width: 209px;\" /> <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/companies/d4ba0c01e92031accc3315b48252a215/53.png\" alt=\"53\" class=\"optional\" style=\"height: 90px; width: 98px;\" /> 
                           </div>
                           </section> -->
                        <div id=\"landingMisc\" class=\"landing-section clearfix\">
                            <div class=\"width-wrapper\">
                                <section id=\"landingTwitterQuotes\">
                                    <blockquote> Mettre l'avis de quelqun </blockquote>
                                    <a href=\"\" class=\"tweet-url\" target=\"_blank\">
                                        <img src=\"https://d2k1ftgv7pobq7.cloudfront.net/images/landing/twitter-avatars/63d666ce159b3035aceaffa9e118137f/mitchellhislop.jpg\" alt=\"twitter user avatar\" /> 
                                        <p class=\"quote-attribution\">Un Ensatien</p>
                                        
                                    </a>
                                </section>
                                <section id=\"landingStayInTouch\">
                                <div class=\"fb-like-box\" data-href=\"https://www.facebook.com/hderty\" data-width=\"200\" data-height=\"100\" data-colorscheme=\"light\" data-show-faces=\"false\" data-header=\"true\" data-stream=\"false\" data-show-border=\"true\"></div>
                                </section>
                               
                            </div>
                        </div>
                        <footer id=\"promoFooter\" class=\"landing-section\">
                            <div class=\"width-wrapper promo-wrapper\">
                                <nav><a href=\"/business-class\">Business Plan</a> <a href=\"/help\">Aide</a> <a class=\"js-real-link\" href=\"/legal\">Terms of Service</a> <a class=\"js-real-link\" href=\"/privacy\">Privacy</a> <a href=\"https://twitter.com/hderty\" target=\"_blank\"><span class=\"icon-sm icon-twitter\"/></a> <a href=\"https://www.facebook.com/hderty\" target=\"_blank\"><span class=\"icon-sm icon-facebook\"/></a> </nav>
                                
                                <p class=\"copyright\"> &copy; Copyright 2014 H-Derty, Inc. Tous les droits résérvés. </p>
                            </div>
                        </footer>
                    </div>
                </div>
...
";
    ...
    {
        return "InnovGroupBundle:Group:accueil2.html.twig";
    }
    ...
    {
        return array (  1114 => 895,  1108 => 892,  1104 => 891,  1100 => 890,  1096 => 889,  1092 => 888,  1088 => 887,  1068 => 870,  1060 => 864,  1055 => 862,  1004 => 819,  1000 => 818,  996 => 817,  992 => 816,  981 => 810,  971 => 805,  967 => 804,  956 => 798,  952 => 797,  942 => 790,  938 => 789,  924 => 777,  916 => 772,  912 => 771,  903 => 767,  897 => 764,  892 => 762,  882 => 755,  876 => 754,  857 => 740,  851 => 739,  845 => 738,  840 => 736,  834 => 735,  829 => 733,  825 => 732,  820 => 731,  817 => 730,  813 => 729,  808 => 727,  804 => 726,  800 => 725,  796 => 724,  793 => 723,  788 => 719,  780 => 716,  772 => 712,  764 => 708,  762 => 707,  758 => 705,  755 => 704,  753 => 703,  750 => 702,  746 => 700,  743 => 699,  741 => 698,  738 => 697,  735 => 696,  733 => 695,  703 => 668,  699 => 667,  694 => 665,  689 => 663,  685 => 662,  487 => 658,  19 => 1,);
    }
}
